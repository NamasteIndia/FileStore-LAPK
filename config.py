...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @apkmod_downloads | Forward this File to Your Saved Messages/Group/Channel. | This File will be available for 05 Minutes Only.</b>")
